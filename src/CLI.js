                    ...
                    {pageName:"northCascades",
                        ...
                        upstream:[
                            {pageName:"entities",
                                ...
                                upstream:[
                                    {pageName:"theRootedOne",
                                        ...
                                        commandLine:'[Root@57.3.55.8][GPI_Base]northCascades/entities/theRootedOne: ',
                                        upstream:[
                                            {pageName:"containment",
                                                content:"<br><p>These emergent beings are often unpredictable and dangerous, capable of venturing beyond The Rooted One's immediate boundaries to inflict chaos upon nearby human settlements. Their origins from the decayed landscape make them inherently hostile and difficult to control, posing a significant threat to civilian populations and infrastructure. The creatures' ability to escape The Rooted One's influence underscores the need for vigilant monitoring and strategic containment.</p>",
                                                commandLine:'[Root@57.3.55.8][GPI_Base]northCascades/entities/theRootedOne/containment: ',
                                                upstream:[]
                                            },
                                            {pageName:"communication",
                                                ...
                                                commandLine:'[Root@57.3.55.8][GPI_Base]northCascades/entities/theRootedOne/communication: ',
                                                upstream:[]
                                            },
                                            {pageName:"scope",
                                                ...
                                                commandLine:'[Root@57.3.55.8][GPI_Base]northCascades/entities/theRootedOne/scope: ',
                                                upstream:[]
                                            },
                                            {pageName:"realityManipulation",
                                                ...
                                                commandLine:'[Root@57.3.55.8][GPI_Base]northCascades/entities/theRootedOne/realityManipulation: ',
                                                upstream:[]
                                            },
                                            {pageName:"conductors",
                                                ...
                                                commandLine:'[Root@57.3.55.8][GPI_Base]northCascades/entities/theRootedOne/conductors: ',
                                                upstream:[]
                                            }
                                        ],
                                    }
                            ...
                            {pageName:"ioi",
                                ...
                                commandLine:'[Root@57.3.55.8][GPI_Base]northCascades/ioi: ',
                                upstream:[
                                    {pageName:"nc-IOI-01",
                                        ...
                                        commandLine:'[Root@57.3.55.8][GPI_Base]northCascades/ioi/nc-IOI-01: ',
                                        upstream:[]
                                    }
                                ]
                            }
